...
router.post('/criar/prontuario',ProntuarioController.criarProntu)
router.post('/cadastro/telefone/:id',TelefoneController.adicionarTelefone)
...
router.put('/alterar/prontuario/:id',ProntuarioController.editarProntu)
...
router.delete('/deletar/telefone/:id',TelefoneController.deletarTelefone)
...
router.delete('/deletar/perfil/:id',PerfilController.deletarPerfil)
